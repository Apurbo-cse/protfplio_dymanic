<section class="section testimonial" id="testi">
            ...
            <div class="swiper-wrapper pt-3">
                ...
                <div class="swiper-slide border-radius position-relative ">
                    <div class="user-image">
                        <img src="{{ asset('frontend/images/team/img1.png') }}" alt="" class="avatar-md rounded-circle">
                    </div>
                ...
                <div class="swiper-slide border-radius position-relative ">
                    <div class="user-image">
                        <img src="{{ asset('frontend/images/team/img2.png') }}" alt="" class="avatar-md rounded-circle">
                    </div>
                    <div class="text-center mt-4">
                        <p class="f-16 text-muted fs-15">" We use a customized application specifically designed a
                            testing gnose to keep away for people. "
                ...
                <div class="swiper-slide border-radius position-relative ">
                    <div class="user-image">
                        <img src="{{ asset('frontend/images/team/img3.png') }}" alt="" class="avatar-md rounded-circle">
                    </div>
                    <div class="text-center mt-4">
                        <p class="f-16 text-muted fs-15">" We use a customized application specifically designed a
                            testing gnose to keep away for people. "
                ...
                <div class="swiper-slide border-radius position-relative ">
                    <div class="user-image">
                        <img src="{{ asset('frontend/images/team/img4.png') }}" alt="" class="avatar-md rounded-circle">
                    </div>
                    <div class="text-center mt-4">
                        <p class="f-16 text-muted fs-15">" We use a customized application specifically designed a
                            testing gnose to keep away for people. "
                ...
                <div class="swiper-slide border-radius position-relative ">
                    <div class="user-image">
                        <img src="{{ asset('frontend/images/team/img5.png') }}" alt="" class="avatar-md rounded-circle">
                    </div>
                    <div class="text-center mt-4">
                        <p class="f-16 text-muted fs-15">" We use a customized application specifically designed a
                            testing gnose to keep away for people. "
    ...
    <div class="shape-3">
        <img src="{{ asset('frontend/images/testi/shape-3.png') }}" alt="" class="img-fluid">
    </div>
    <!-- end container -->
</section>
